...
class registro extends CI_Controller {
	...
	public function registrarAlumno() {
		...
		$data = $this -> abm_alumno_model -> registrarAlumno($nombres, $apellidos, $direccion, $dni, $telefono, $celular, $sexo, $nacimiento, $correo, $grado, $seccion);
		$datos['title'] = $data;
	...
	public function registrarDocente() {
		...
		$data = $this -> abm_docente_model -> registrarDocente($nombres, $apellidos, $direccion, $dni, $telefono, $celular, $sexo, $nacimiento, $correo);
		$datos['title'] = $data;
		$datos['vista'] = '<h2>' . $data . '</h2><br /><a class="btn btn-info" href="javascript:history.back(1)">Regresar</a>';
		$this -> load -> view('template/layout', $datos);
