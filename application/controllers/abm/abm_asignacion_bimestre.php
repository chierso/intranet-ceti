...
class abm_asignacion_bimestre extends CI_Controller {
	...
	public function insert() {
		...
		$calendario = array("primer_bimestre" => $i, "segundo_bimestre" => $ii, "tercer_bimestre" => $iii, "cuarto_bimestre" => $iv, "year" => $ano_vigente);
	...
	public function update() {
		...
		$iii = $this -> input -> post('iiibimestre', TRUE) . "";
		$iv = $this -> input -> post('ivbimestre', TRUE) . "";
		$calendario = array("primer_bimestre" => $i, "segundo_bimestre" => $ii, "tercer_bimestre" => $iii, "cuarto_bimestre" => $iv);
