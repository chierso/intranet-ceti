	...
	<div class="row-fluid">
		...
		<div class="row-fluid">
			<div class="span6">
				...
				<input type="text" id="Telefono" name="txt_telefono" class="span12" placeholder="EJ. 7482005" size="16" />
			</div>
			<div class="span6">
				<label for="Celular">Celular</label>
				<input type="text" id="Celular" name="txt_celular" class="span12" placeholder="EJ. 97412587" size="16" />
			</div>
		</div>
		<div class="row-fluid">
			<div class="span4">
