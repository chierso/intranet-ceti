...
-- Script date 01/05/2013 01:35:56 p.m.
...
--
-- Definition for table tbl_subject_docente
--
CREATE TABLE tbl_subject_docente (
  id_subject_docente INT(11) NOT NULL AUTO_INCREMENT,
  id_subject INT(11) DEFAULT NULL,
  id_docente INT(11) DEFAULT NULL,
  salon VARCHAR(255) DEFAULT NULL,
  PRIMARY KEY (id_subject_docente),
  INDEX FK_tbl_subject_docente_tbl_docente_id_docente (id_docente),
  INDEX FK_tbl_subject_docente_tbl_subject_id_subject (id_subject),
  CONSTRAINT FK_tbl_subject_docente_tbl_docente_id_docente FOREIGN KEY (id_docente)
    REFERENCES tbl_docente(id_docente) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT FK_tbl_subject_docente_tbl_subject_id_subject FOREIGN KEY (id_subject)
    REFERENCES tbl_subject(id_subject) ON DELETE RESTRICT ON UPDATE RESTRICT
)
ENGINE = INNODB
AUTO_INCREMENT = 1
...
--
-- Definition for table tbl_tutoria
--
CREATE TABLE tbl_tutoria (
  ...
  INDEX FK_tbl_tutoria_tbl_docente_id_docente (id_docente),
  INDEX FK_tbl_tutoria_tbl_year_id_year_achademic (id_year),
  CONSTRAINT FK_tbl_tutoria_tbl_docente_id_docente FOREIGN KEY (id_docente)
    REFERENCES tbl_docente(id_docente) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT FK_tbl_tutoria_tbl_year_id_year_achademic FOREIGN KEY (id_year)
    REFERENCES tbl_year(id_year_achademic) ON DELETE RESTRICT ON UPDATE RESTRICT
)
ENGINE = INNODB
AUTO_INCREMENT = 1
CHARACTER SET latin1
...
--
CREATE TABLE tbl_year_bimester (
  ...
  CONSTRAINT FK_tbl_year_bimester_tbl_bimester_id_bimester FOREIGN KEY (id_bimester)
    REFERENCES tbl_bimester(id_bimester) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
--
-- Table intranet_ceti.tbl_subject does not contain any data (it is empty)
...
--
-- Table intranet_ceti.tbl_bimester does not contain any data (it is empty)
...
-- 
-- Dumping data for table tbl_subject_docente
--
-- Table intranet_ceti.tbl_subject_docente does not contain any data (it is empty)

-- 
-- Dumping data for table tbl_tutoria
--
-- Table intranet_ceti.tbl_tutoria does not contain any data (it is empty)
...
--
-- Table intranet_ceti.tbl_year_bimester does not contain any data (it is empty)
