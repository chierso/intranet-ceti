...
-- Script date 03/05/2013 01:45:52 a.m.
...
--
-- Definition for table tbl_asignacion_tutoria
--
CREATE TABLE tbl_asignacion_tutoria (
  ...
  CONSTRAINT FK_tbl_salon_docente_tbl_docente_id_docente FOREIGN KEY (id_docente)
...
-- 
-- Dumping data for table tbl_asignacion_tutoria
--
-- Table intranet_ceti.tbl_asignacion_tutoria does not contain any data (it is empty)
